...
if (!file.exists(seurat_path)) {
    ...
    seurat_merge_infercnv <- subset(seurat_merge, subset = cellTypes_new %in% c('Epithelial cell','Basal-like epithelial cell', 'Endothelial cell','Luminal epithelium cell', 'Macrophage','T cell','B cell','Intestinal epithelial cell','Cycling epithelial cell'))
...
run_infercnv = function(sample) {
  ...
  infercnv_obj <- CreateInfercnvObject(raw_counts_matrix = count_mat, 
                                       ...
                                       #  ref_group_names = c("Tcell", "Macrophage", "Endothelial"),
                                        ref_group_names = c("T cell", "B cell", "Macrophage", "Endothelial cell"),
